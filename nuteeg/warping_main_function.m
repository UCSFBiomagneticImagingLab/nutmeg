...
function [Ptm, ind, Cscalp_w,Cskull_w,CCSF_w,Cbrain_w, W,A,e,LMm2,back,Escalp,Eskull,ECSF,Ebrain] = warping_main_function(Fd, elo)
...
index_kdm = []; %find((dm < 2*mdm)); % kdm gives the index of the electrodes close to the scalp
