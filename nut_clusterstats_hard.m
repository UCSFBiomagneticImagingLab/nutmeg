function CP = nut_clusterstats_hard(R,P,beam,MinClusterSize, hardthresh, firstpass)
% nut_clusterstats  thresholds multiple voxel stats with cluster size.
%
% p_cluster_corr = nut_clusterstats(statval,p_uncorr,beam,MinClusterSize,firstpass)
